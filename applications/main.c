...
int main(void)
{
	...
	rt_thread_deferrable_init(rt_tick_from_millisecond(1000),
							  rt_tick_from_millisecond(205000),
							  THREAD_PRIORITY_DEF);
#endif
